...
pickle.dump(X1, open('X1preNumpy.pkl', "wb"))
pickle.dump(X2, open('X2preNumpy.pkl', "wb"))
pickle.dump(y1, open('y1preNumpy.pkl', "wb"))
pickle.dump(y2, open('y2preNumpy.pkl', "wb"))
'''
...
def imageLoading():
    X1 = pickle.load(open('X1_preNumpy.pkl', 'rb'))
    X2 = pickle.load(open('X2_preNumpy.pkl', 'rb'))
    y1 = pickle.load(open('y1_preNumpy.pkl', 'rb'))
    y2 = pickle.load(open('y2_preNumpy.pkl', 'rb'))
